...
class OrderCardUIDesign extends StatelessWidget
{
  ...
  OrderCardUIDesign({super.key, this.itemCount, this.data, this.orderID, this.seperateQuantitiesList,});
...
Widget placedOrderDesignWidget(Item model, BuildContext context, String quantityNumber)
{
  return SizedBox(
